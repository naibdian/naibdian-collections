...
## NaibdiaN Shape Collection


Shape is 4th collection based on biomorphic dynamic large particle systems. Every token in the collection is unique. You're not acquiring just a static image but a realtime simulation of an evolving microbiome. You can replay/start/stop same evolution (left click).
